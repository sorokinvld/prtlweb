...
export default {
  project: {
    link: 'https://prtl.cc' // GitHub link in the navbar
  },
  docsRepositoryBase: 'https://github.com', // base URL for the docs repository
  getNextSeoProps: () => ({ titleTemplate: '%s – Prtl' }),
  navigation: true,
  darkMode: true,
  footer: {
    text: `MIT ${new Date().getFullYear()} © prtl.`
  },
  editLink: {
    text: 'Powered'
  },
  ...
  head: (
    <>
      ...
      <meta name="description" content="docs builder" />
...
<Callout>
  ...
  and title. <br /> Check the source code: https://github.com/shung/ for
  more information.
</Callout>
